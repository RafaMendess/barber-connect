...
public class AvailabilityService {
    ...
    public AvailabilityResponseDto create(Long barberId,
        ...
        if (availabilityRepository.existsByBarberIdAndDayOfWeekAndActiveTrue(barberId, dto.dayOfWeek())) {
    ...
    public AvailabilityResponseDto update(Long barberId,
        ...
        if (dto.dayOfWeek() != null && !dto.dayOfWeek().equals(availability.getDayOfWeek())) {
            if (availabilityRepository.existsByBarberIdAndDayOfWeekAndActiveTrue(barberId, dto.dayOfWeek())) {
                throw new BusinessException(
                        "Barber already has an availability registered for day " + dto.dayOfWeek());
            }
        ...
        // Valida consistência de horários usando os valores finais (novo ou atual)
